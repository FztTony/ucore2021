...
/home/tonyfu/riscv/ucore-Tutorial/user/build/riscv64/exit:     file format elf64-littleriscv
...
int putchar(int c)
{
    ...
    1042:	c6258593          	addi	a1,a1,-926 # 1ca0 <put.1058>
...
int puts(const char* s)
{
    ...
    1082:	c2258593          	addi	a1,a1,-990 # 1ca0 <put.1058>
    1086:	47a9                	li	a5,10
    return write(stdout, put, 1);
    1088:	4605                	li	a2,1
    108a:	4501                	li	a0,0
...
void printf(const char* fmt, ...) {
    ...
    10e8:	bbc40413          	addi	s0,s0,-1092 # 1ca0 <put.1058>
    10ec:	03000c93          	li	s9,48
    10f0:	07800c13          	li	s8,120
    10f4:	00001b17          	auipc	s6,0x1
    10f8:	b94b0b13          	addi	s6,s6,-1132 # 1c88 <digits>
        if (c != '%') {
    ...
    125e:	a4658593          	addi	a1,a1,-1466 # 1ca0 <put.1058>
    1262:	4501                	li	a0,0
    put[0] = c;
    ...
    12b4:	9f058593          	addi	a1,a1,-1552 # 1ca0 <put.1058>
                printptr(va_arg(ap, uint64));
    ...
    12d2:	9d258593          	addi	a1,a1,-1582 # 1ca0 <put.1058>
    12d6:	4501                	li	a0,0
    put[0] = c;
    ...
    1318:	98c58593          	addi	a1,a1,-1652 # 1ca0 <put.1058>
    131c:	4501                	li	a0,0
    put[0] = c;
    ...
    132c:	97858593          	addi	a1,a1,-1672 # 1ca0 <put.1058>
    1330:	4501                	li	a0,0
    put[0] = c;
    ...
    134e:	95658593          	addi	a1,a1,-1706 # 1ca0 <put.1058>
    1352:	4501                	li	a0,0
    put[0] = c;
    ...
    138e:	8d648493          	addi	s1,s1,-1834 # 1c60 <main+0x196>
                for (; *s; s++)
...
size_t strlen(const char* s)
{
    ...
    1694:	5e05b583          	ld	a1,1504(a1) # 1c70 <max_child+0x4>
    1698:	00000617          	auipc	a2,0x0
    169c:	5e063603          	ld	a2,1504(a2) # 1c78 <max_child+0xc>
    ...
    16cc:	00757713          	andi	a4,a0,7
{
    ...
    16fc:	58853503          	ld	a0,1416(a0) # 1c80 <max_child+0x14>
    ...
    170e:	5668b883          	ld	a7,1382(a7) # 1c70 <max_child+0x4>
    1712:	00000817          	auipc	a6,0x0
    1716:	56683803          	ld	a6,1382(a6) # 1c78 <max_child+0xc>
    171a:	431d                	li	t1,7
...
char* stpcpy(char* restrict d, const char* s)
{
    ...
    179c:	4d863603          	ld	a2,1240(a2) # 1c70 <max_child+0x4>
    17a0:	00000817          	auipc	a6,0x0
    17a4:	4d883803          	ld	a6,1240(a6) # 1c78 <max_child+0xc>
...
char* stpncpy(char* restrict d, const char* s, size_t n)
{
    ...
    197e:	2f68b883          	ld	a7,758(a7) # 1c70 <max_child+0x4>
    1982:	00000817          	auipc	a6,0x0
    1986:	2f683803          	ld	a6,758(a6) # 1c78 <max_child+0xc>
    198a:	431d                	li	t1,7
...
int main(void) {
    1aca:	7179                	addi	sp,sp,-48
    puts("I am the parent. Forking the child...");
    1acc:	00000517          	auipc	a0,0x0
    1ad0:	0cc50513          	addi	a0,a0,204 # 1b98 <main+0xce>
int main(void) {
    1ad4:	f406                	sd	ra,40(sp)
    1ad6:	ec26                	sd	s1,24(sp)
    1ad8:	f022                	sd	s0,32(sp)
    puts("I am the parent. Forking the child...");
    1ada:	d80ff0ef          	jal	ra,105a <puts>
    int pid = fork();
    1ade:	f7bff0ef          	jal	ra,1a58 <fork>
    1ae2:	84aa                	mv	s1,a0
    if (pid == 0) {
    1ae4:	e959                	bnez	a0,1b7a <main+0xb0>
        puts("I am the child.");
    1ae6:	00000517          	auipc	a0,0x0
    1aea:	0da50513          	addi	a0,a0,218 # 1bc0 <main+0xf6>
    1aee:	d6cff0ef          	jal	ra,105a <puts>
    1af2:	4421                	li	s0,8
        for(int i = 0; i < 8; ++i) {
            sched_yield();
    1af4:	347d                	addiw	s0,s0,-1
    1af6:	f57ff0ef          	jal	ra,1a4c <sched_yield>
        for(int i = 0; i < 8; ++i) {
    1afa:	fc6d                	bnez	s0,1af4 <main+0x2a>
        }
        exit(MAGIC);
    1afc:	6505                	lui	a0,0x1
    1afe:	23450513          	addi	a0,a0,564 # 1234 <printf+0x194>
    1b02:	f63ff0ef          	jal	ra,1a64 <exit>
    } else {
        printf("I am parent, fork a child pid %d\n", pid);
    }

    puts("I am the parent, waiting now..");
    1b06:	00000517          	auipc	a0,0x0
    1b0a:	0f250513          	addi	a0,a0,242 # 1bf8 <main+0x12e>
    1b0e:	d4cff0ef          	jal	ra,105a <puts>
    int xstate = 0;
    if(wait(pid, &xstate) != pid || xstate != MAGIC) {
    1b12:	006c                	addi	a1,sp,12
    1b14:	8526                	mv	a0,s1
    int xstate = 0;
    1b16:	c602                	sw	zero,12(sp)
    if(wait(pid, &xstate) != pid || xstate != MAGIC) {
    1b18:	f57ff0ef          	jal	ra,1a6e <wait>
    1b1c:	00951863          	bne	a0,s1,1b2c <main+0x62>
    1b20:	4732                	lw	a4,12(sp)
    1b22:	6785                	lui	a5,0x1
    1b24:	23478793          	addi	a5,a5,564 # 1234 <printf+0x194>
    1b28:	00f70963          	beq	a4,a5,1b3a <main+0x70>
        printf("wait %d fail\n", pid);
    1b2c:	85a6                	mv	a1,s1
    1b2e:	00000517          	auipc	a0,0x0
    1b32:	0ea50513          	addi	a0,a0,234 # 1c18 <main+0x14e>
    1b36:	d6aff0ef          	jal	ra,10a0 <printf>
    }
    if(wait(pid, &xstate) > 0 || wait(-1, &xstate) > 0) {
    1b3a:	006c                	addi	a1,sp,12
    1b3c:	8526                	mv	a0,s1
    1b3e:	f31ff0ef          	jal	ra,1a6e <wait>
    1b42:	04a05463          	blez	a0,1b8a <main+0xc0>
        printf("wait should fail\n", pid);
    1b46:	85a6                	mv	a1,s1
    1b48:	00000517          	auipc	a0,0x0
    1b4c:	0e050513          	addi	a0,a0,224 # 1c28 <main+0x15e>
    1b50:	d50ff0ef          	jal	ra,10a0 <printf>
    }
    printf("waitpid %d ok.\n", pid);
    1b54:	85a6                	mv	a1,s1
    1b56:	00000517          	auipc	a0,0x0
    1b5a:	0ea50513          	addi	a0,a0,234 # 1c40 <main+0x176>
    1b5e:	d42ff0ef          	jal	ra,10a0 <printf>
    puts("exit pass.");
    1b62:	00000517          	auipc	a0,0x0
    1b66:	0ee50513          	addi	a0,a0,238 # 1c50 <main+0x186>
    1b6a:	cf0ff0ef          	jal	ra,105a <puts>
    return 0;
}
    1b6e:	70a2                	ld	ra,40(sp)
    1b70:	7402                	ld	s0,32(sp)
    1b72:	64e2                	ld	s1,24(sp)
    1b74:	4501                	li	a0,0
    1b76:	6145                	addi	sp,sp,48
    1b78:	8082                	ret
        printf("I am parent, fork a child pid %d\n", pid);
    1b7a:	85aa                	mv	a1,a0
    1b7c:	00000517          	auipc	a0,0x0
    1b80:	05450513          	addi	a0,a0,84 # 1bd0 <main+0x106>
    1b84:	d1cff0ef          	jal	ra,10a0 <printf>
    1b88:	bfbd                	j	1b06 <main+0x3c>
    if(wait(pid, &xstate) > 0 || wait(-1, &xstate) > 0) {
    1b8a:	006c                	addi	a1,sp,12
    1b8c:	557d                	li	a0,-1
    1b8e:	ee1ff0ef          	jal	ra,1a6e <wait>
    1b92:	faa04ae3          	bgtz	a0,1b46 <main+0x7c>
    1b96:	bf7d                	j	1b54 <main+0x8a>
