...
/home/tonyfu/riscv/ucore-Tutorial/user/build/riscv64/hello:     file format elf64-littleriscv
...
int putchar(int c)
{
    ...
    1042:	af258593          	addi	a1,a1,-1294 # 1b30 <put.1058>
...
int puts(const char* s)
{
    ...
    1082:	ab258593          	addi	a1,a1,-1358 # 1b30 <put.1058>
    1086:	47a9                	li	a5,10
    return write(stdout, put, 1);
    1088:	4605                	li	a2,1
    108a:	4501                	li	a0,0
...
void printf(const char* fmt, ...) {
    ...
    10e8:	a4c40413          	addi	s0,s0,-1460 # 1b30 <put.1058>
    10ec:	03000c93          	li	s9,48
    10f0:	07800c13          	li	s8,120
    10f4:	00001b17          	auipc	s6,0x1
    10f8:	a24b0b13          	addi	s6,s6,-1500 # 1b18 <digits>
        if (c != '%') {
    ...
    125e:	8d658593          	addi	a1,a1,-1834 # 1b30 <put.1058>
    1262:	4501                	li	a0,0
    put[0] = c;
    ...
    12b4:	88058593          	addi	a1,a1,-1920 # 1b30 <put.1058>
                printptr(va_arg(ap, uint64));
    ...
    12d2:	86258593          	addi	a1,a1,-1950 # 1b30 <put.1058>
    12d6:	4501                	li	a0,0
    put[0] = c;
    ...
    1318:	81c58593          	addi	a1,a1,-2020 # 1b30 <put.1058>
    131c:	4501                	li	a0,0
    put[0] = c;
    ...
    132c:	80858593          	addi	a1,a1,-2040 # 1b30 <put.1058>
    1330:	4501                	li	a0,0
    put[0] = c;
    ...
    134e:	7e658593          	addi	a1,a1,2022 # 1b30 <put.1058>
    1352:	4501                	li	a0,0
    put[0] = c;
    ...
    138e:	76e48493          	addi	s1,s1,1902 # 1af8 <main+0x2e>
                for (; *s; s++)
...
size_t strlen(const char* s)
{
    ...
    1694:	4705b583          	ld	a1,1136(a1) # 1b00 <main+0x36>
    1698:	00000617          	auipc	a2,0x0
    169c:	47063603          	ld	a2,1136(a2) # 1b08 <main+0x3e>
    ...
    16cc:	00757713          	andi	a4,a0,7
{
    ...
    16fc:	41853503          	ld	a0,1048(a0) # 1b10 <main+0x46>
    ...
    170e:	3f68b883          	ld	a7,1014(a7) # 1b00 <main+0x36>
    1712:	00000817          	auipc	a6,0x0
    1716:	3f683803          	ld	a6,1014(a6) # 1b08 <main+0x3e>
    171a:	431d                	li	t1,7
...
char* stpcpy(char* restrict d, const char* s)
{
    ...
    179c:	36863603          	ld	a2,872(a2) # 1b00 <main+0x36>
    17a0:	00000817          	auipc	a6,0x0
    17a4:	36883803          	ld	a6,872(a6) # 1b08 <main+0x3e>
...
char* stpncpy(char* restrict d, const char* s, size_t n)
{
    ...
    197e:	1868b883          	ld	a7,390(a7) # 1b00 <main+0x36>
    1982:	00000817          	auipc	a6,0x0
    1986:	18683803          	ld	a6,390(a6) # 1b08 <main+0x3e>
    198a:	431d                	li	t1,7
...
int main() {
    ...
    1ad0:	01c50513          	addi	a0,a0,28 # 1ae8 <main+0x1e>
int main() {
    1ad4:	e406                	sd	ra,8(sp)
    puts("hello wrold!");
    1ad6:	d84ff0ef          	jal	ra,105a <puts>
    return 0;
    1ada:	60a2                	ld	ra,8(sp)
    1adc:	4501                	li	a0,0
    1ade:	0141                	addi	sp,sp,16
    1ae0:	8082                	ret
