...
/home/tonyfu/riscv/ucore-Tutorial/user/build/riscv64/pipetest:     file format elf64-littleriscv
...
int putchar(int c)
{
    ...
    1042:	d1258593          	addi	a1,a1,-750 # 1d50 <put.1058>
...
int puts(const char* s)
{
    ...
    1082:	cd258593          	addi	a1,a1,-814 # 1d50 <put.1058>
    1086:	47a9                	li	a5,10
    return write(stdout, put, 1);
    1088:	4605                	li	a2,1
    108a:	4501                	li	a0,0
...
void printf(const char* fmt, ...) {
    ...
    10e8:	c6c40413          	addi	s0,s0,-916 # 1d50 <put.1058>
    10ec:	03000c93          	li	s9,48
    10f0:	07800c13          	li	s8,120
    10f4:	00001b17          	auipc	s6,0x1
    10f8:	c44b0b13          	addi	s6,s6,-956 # 1d38 <digits>
        if (c != '%') {
    ...
    125e:	af658593          	addi	a1,a1,-1290 # 1d50 <put.1058>
    1262:	4501                	li	a0,0
    put[0] = c;
    ...
    12b4:	aa058593          	addi	a1,a1,-1376 # 1d50 <put.1058>
                printptr(va_arg(ap, uint64));
    ...
    12d2:	a8258593          	addi	a1,a1,-1406 # 1d50 <put.1058>
    12d6:	4501                	li	a0,0
    put[0] = c;
    ...
    1318:	a3c58593          	addi	a1,a1,-1476 # 1d50 <put.1058>
    131c:	4501                	li	a0,0
    put[0] = c;
    ...
    132c:	a2858593          	addi	a1,a1,-1496 # 1d50 <put.1058>
    1330:	4501                	li	a0,0
    put[0] = c;
    ...
    134e:	a0658593          	addi	a1,a1,-1530 # 1d50 <put.1058>
    1352:	4501                	li	a0,0
    put[0] = c;
    ...
    138e:	97648493          	addi	s1,s1,-1674 # 1d00 <main+0x1ea>
                for (; *s; s++)
...
void srand(unsigned s) {
    ...
    13ac:	9aa7b823          	sd	a0,-1616(a5) # 1d58 <seed>
}
    13b0:	8082                	ret
...
int rand(void) {
    ...
    13b6:	9a678793          	addi	a5,a5,-1626 # 1d58 <seed>
    13ba:	6388                	ld	a0,0(a5)
    13bc:	00001717          	auipc	a4,0x1
    13c0:	94c73703          	ld	a4,-1716(a4) # 1d08 <main+0x1f2>
...
size_t strlen(const char* s)
{
    ...
    16e0:	6345b583          	ld	a1,1588(a1) # 1d10 <main+0x1fa>
    16e4:	00000617          	auipc	a2,0x0
    16e8:	63463603          	ld	a2,1588(a2) # 1d18 <main+0x202>
    ...
    1718:	00757713          	andi	a4,a0,7
{
    ...
    1748:	5dc53503          	ld	a0,1500(a0) # 1d20 <main+0x20a>
    ...
    175a:	5ba8b883          	ld	a7,1466(a7) # 1d10 <main+0x1fa>
    175e:	00000817          	auipc	a6,0x0
    1762:	5ba83803          	ld	a6,1466(a6) # 1d18 <main+0x202>
    1766:	431d                	li	t1,7
...
char* stpcpy(char* restrict d, const char* s)
{
    ...
    17e8:	52c63603          	ld	a2,1324(a2) # 1d10 <main+0x1fa>
    17ec:	00000817          	auipc	a6,0x0
    17f0:	52c83803          	ld	a6,1324(a6) # 1d18 <main+0x202>
...
char* stpncpy(char* restrict d, const char* s, size_t n)
{
    ...
    19ca:	34a8b883          	ld	a7,842(a7) # 1d10 <main+0x1fa>
    19ce:	00000817          	auipc	a6,0x0
    19d2:	34a83803          	ld	a6,842(a6) # 1d18 <main+0x202>
    19d6:	431d                	li	t1,7
...
int main() {
    1b16:	715d                	addi	sp,sp,-80
    // create pipe
    uint64 pipe_fd[2];
    int ret = pipe((void*)&pipe_fd);
    1b18:	0028                	addi	a0,sp,8
int main() {
    1b1a:	e486                	sd	ra,72(sp)
    1b1c:	e0a2                	sd	s0,64(sp)
    int ret = pipe((void*)&pipe_fd);
    1b1e:	fedff0ef          	jal	ra,1b0a <pipe>
    assert(ret == 0, -2);
    1b22:	55f9                	li	a1,-2
    1b24:	00153513          	seqz	a0,a0
    1b28:	8bdff0ef          	jal	ra,13e4 <assert>
    printf("[parent] read end = %p, write end = %p\n", pipe_fd[0], pipe_fd[1]);
    1b2c:	6642                	ld	a2,16(sp)
    1b2e:	65a2                	ld	a1,8(sp)
    1b30:	00000517          	auipc	a0,0x0
    1b34:	10850513          	addi	a0,a0,264 # 1c38 <main+0x122>
    1b38:	d68ff0ef          	jal	ra,10a0 <printf>
    if (fork() == 0) {
    1b3c:	f69ff0ef          	jal	ra,1aa4 <fork>
    1b40:	c551                	beqz	a0,1bcc <main+0xb6>
        ...
        // close read end
        close(pipe_fd[0]);
    1b42:	4522                	lw	a0,8(sp)
    1b44:	f29ff0ef          	jal	ra,1a6c <close>
        printf("[parent] close read end\n");
    1b48:	00000517          	auipc	a0,0x0
    1b4c:	16850513          	addi	a0,a0,360 # 1cb0 <main+0x19a>
    1b50:	d50ff0ef          	jal	ra,10a0 <printf>
        assert(write(pipe_fd[1], STR, strlen(STR)) == strlen(STR), -3);
    1b54:	4442                	lw	s0,16(sp)
    1b56:	00000517          	auipc	a0,0x0
    1b5a:	1d250513          	addi	a0,a0,466 # 1d28 <STR>
    1b5e:	b5dff0ef          	jal	ra,16ba <strlen>
    1b62:	862a                	mv	a2,a0
    1b64:	00000597          	auipc	a1,0x0
    1b68:	1c458593          	addi	a1,a1,452 # 1d28 <STR>
    1b6c:	8522                	mv	a0,s0
    1b6e:	f15ff0ef          	jal	ra,1a82 <write>
    1b72:	842a                	mv	s0,a0
    1b74:	00000517          	auipc	a0,0x0
    1b78:	1b450513          	addi	a0,a0,436 # 1d28 <STR>
    1b7c:	b3fff0ef          	jal	ra,16ba <strlen>
    1b80:	40a40533          	sub	a0,s0,a0
    1b84:	55f5                	li	a1,-3
    1b86:	00153513          	seqz	a0,a0
    1b8a:	85bff0ef          	jal	ra,13e4 <assert>
        printf("[parent] write over\n");
    1b8e:	00000517          	auipc	a0,0x0
    1b92:	14250513          	addi	a0,a0,322 # 1cd0 <main+0x1ba>
    1b96:	d0aff0ef          	jal	ra,10a0 <printf>
        // close write end
        close(pipe_fd[1]);
    1b9a:	4542                	lw	a0,16(sp)
    1b9c:	ed1ff0ef          	jal	ra,1a6c <close>
        int exit_code = 0;
        wait(-1, &exit_code);
    1ba0:	082c                	addi	a1,sp,24
    1ba2:	557d                	li	a0,-1
        int exit_code = 0;
    1ba4:	cc02                	sw	zero,24(sp)
        wait(-1, &exit_code);
    1ba6:	f15ff0ef          	jal	ra,1aba <wait>
        assert(exit_code == 0, -2);
    1baa:	4562                	lw	a0,24(sp)
    1bac:	55f9                	li	a1,-2
    1bae:	00153513          	seqz	a0,a0
    1bb2:	833ff0ef          	jal	ra,13e4 <assert>
        puts("pipetest passed!");
    1bb6:	00000517          	auipc	a0,0x0
    1bba:	13250513          	addi	a0,a0,306 # 1ce8 <main+0x1d2>
    1bbe:	c9cff0ef          	jal	ra,105a <puts>
    }
    return 0;
}
    1bc2:	60a6                	ld	ra,72(sp)
    1bc4:	6406                	ld	s0,64(sp)
    1bc6:	4501                	li	a0,0
    1bc8:	6161                	addi	sp,sp,80
    1bca:	8082                	ret
        close(pipe_fd[1]);
    1bcc:	4542                	lw	a0,16(sp)
    1bce:	e9fff0ef          	jal	ra,1a6c <close>
        puts("[child] close write end");
    1bd2:	00000517          	auipc	a0,0x0
    1bd6:	08e50513          	addi	a0,a0,142 # 1c60 <main+0x14a>
    1bda:	c80ff0ef          	jal	ra,105a <puts>
        int len_read = read(pipe_fd[0], buffer, 32);
    1bde:	4522                	lw	a0,8(sp)
    1be0:	082c                	addi	a1,sp,24
    1be2:	02000613          	li	a2,32
    1be6:	e93ff0ef          	jal	ra,1a78 <read>
    1bea:	842a                	mv	s0,a0
        puts("[chile] read over");
    1bec:	00000517          	auipc	a0,0x0
    1bf0:	08c50513          	addi	a0,a0,140 # 1c78 <main+0x162>
    1bf4:	c66ff0ef          	jal	ra,105a <puts>
        buffer[len_read] = 0;
    1bf8:	009c                	addi	a5,sp,64
    1bfa:	2401                	sext.w	s0,s0
    1bfc:	943e                	add	s0,s0,a5
        assert(strncmp(buffer, STR, strlen(STR)) == 0, -3);
    1bfe:	00000517          	auipc	a0,0x0
    1c02:	12a50513          	addi	a0,a0,298 # 1d28 <STR>
        buffer[len_read] = 0;
    1c06:	fc040c23          	sb	zero,-40(s0)
        assert(strncmp(buffer, STR, strlen(STR)) == 0, -3);
    1c0a:	ab1ff0ef          	jal	ra,16ba <strlen>
    1c0e:	862a                	mv	a2,a0
    1c10:	00000597          	auipc	a1,0x0
    1c14:	11858593          	addi	a1,a1,280 # 1d28 <STR>
    1c18:	0828                	addi	a0,sp,24
    1c1a:	a5fff0ef          	jal	ra,1678 <strncmp>
    1c1e:	00153513          	seqz	a0,a0
    1c22:	55f5                	li	a1,-3
    1c24:	fc0ff0ef          	jal	ra,13e4 <assert>
        puts("Read OK, child process exited!");
    1c28:	00000517          	auipc	a0,0x0
    1c2c:	06850513          	addi	a0,a0,104 # 1c90 <main+0x17a>
    1c30:	c2aff0ef          	jal	ra,105a <puts>
        return 0;
    1c34:	b779                	j	1bc2 <main+0xac>
