...
/home/tonyfu/riscv/ucore-Tutorial/user/build/riscv64/forktest2:     file format elf64-littleriscv
...
int putchar(int c)
{
    ...
    1042:	c2258593          	addi	a1,a1,-990 # 1c60 <put.1058>
...
int puts(const char* s)
{
    ...
    1082:	be258593          	addi	a1,a1,-1054 # 1c60 <put.1058>
    1086:	47a9                	li	a5,10
    return write(stdout, put, 1);
    1088:	4605                	li	a2,1
    108a:	4501                	li	a0,0
...
void printf(const char* fmt, ...) {
    ...
    10e8:	b7c40413          	addi	s0,s0,-1156 # 1c60 <put.1058>
    10ec:	03000c93          	li	s9,48
    10f0:	07800c13          	li	s8,120
    10f4:	00001b17          	auipc	s6,0x1
    10f8:	b54b0b13          	addi	s6,s6,-1196 # 1c48 <digits>
        if (c != '%') {
    ...
    125e:	a0658593          	addi	a1,a1,-1530 # 1c60 <put.1058>
    1262:	4501                	li	a0,0
    put[0] = c;
    ...
    12b4:	9b058593          	addi	a1,a1,-1616 # 1c60 <put.1058>
                printptr(va_arg(ap, uint64));
    ...
    12d2:	99258593          	addi	a1,a1,-1646 # 1c60 <put.1058>
    12d6:	4501                	li	a0,0
    put[0] = c;
    ...
    1318:	94c58593          	addi	a1,a1,-1716 # 1c60 <put.1058>
    131c:	4501                	li	a0,0
    put[0] = c;
    ...
    132c:	93858593          	addi	a1,a1,-1736 # 1c60 <put.1058>
    1330:	4501                	li	a0,0
    put[0] = c;
    ...
    134e:	91658593          	addi	a1,a1,-1770 # 1c60 <put.1058>
    1352:	4501                	li	a0,0
    put[0] = c;
    ...
    138e:	88e48493          	addi	s1,s1,-1906 # 1c18 <main+0x102>
                for (; *s; s++)
...
void srand(unsigned s) {
    ...
    13ac:	8ca7b023          	sd	a0,-1856(a5) # 1c68 <seed>
}
    13b0:	8082                	ret
...
int rand(void) {
    ...
    13b6:	8b678793          	addi	a5,a5,-1866 # 1c68 <seed>
    13ba:	6388                	ld	a0,0(a5)
    13bc:	00001717          	auipc	a4,0x1
    13c0:	86c73703          	ld	a4,-1940(a4) # 1c28 <NUM+0x8>
...
size_t strlen(const char* s)
{
    ...
    16e0:	5545b583          	ld	a1,1364(a1) # 1c30 <NUM+0x10>
    16e4:	00000617          	auipc	a2,0x0
    16e8:	55463603          	ld	a2,1364(a2) # 1c38 <NUM+0x18>
    ...
    1718:	00757713          	andi	a4,a0,7
{
    ...
    1748:	4fc53503          	ld	a0,1276(a0) # 1c40 <NUM+0x20>
    ...
    175a:	4da8b883          	ld	a7,1242(a7) # 1c30 <NUM+0x10>
    175e:	00000817          	auipc	a6,0x0
    1762:	4da83803          	ld	a6,1242(a6) # 1c38 <NUM+0x18>
    1766:	431d                	li	t1,7
...
char* stpcpy(char* restrict d, const char* s)
{
    ...
    17e8:	44c63603          	ld	a2,1100(a2) # 1c30 <NUM+0x10>
    17ec:	00000817          	auipc	a6,0x0
    17f0:	44c83803          	ld	a6,1100(a6) # 1c38 <NUM+0x18>
...
char* stpncpy(char* restrict d, const char* s, size_t n)
{
    ...
    19ca:	26a8b883          	ld	a7,618(a7) # 1c30 <NUM+0x10>
    19ce:	00000817          	auipc	a6,0x0
    19d2:	26a83803          	ld	a6,618(a6) # 1c38 <NUM+0x18>
    19d6:	431d                	li	t1,7
...
int main() {
    ...
    1b18:	f426                	sd	s1,40(sp)
    1b1a:	f04a                	sd	s2,32(sp)
    1b1c:	ec4e                	sd	s3,24(sp)
    1b1e:	e852                	sd	s4,16(sp)
    1b20:	fc06                	sd	ra,56(sp)
    1b22:	f822                	sd	s0,48(sp)
    1b24:	44f9                	li	s1,30
    for(int i = 0; i < NUM; ++i) {
        int pid = fork();
        if(pid == 0) {
    ...
    1b26:	3e800a13          	li	s4,1000
            printf("pid %d sleep for %p ms\n", getpid(), sleep_length);
    1b2a:	00000997          	auipc	s3,0x0
    1b2e:	0ae98993          	addi	s3,s3,174 # 1bd8 <main+0xc2>
            sleep(sleep_length);
            printf("pid %d OK!\n", getpid());
    1b32:	00000917          	auipc	s2,0x0
    1b36:	0be90913          	addi	s2,s2,190 # 1bf0 <main+0xda>
        int pid = fork();
    1b3a:	f6bff0ef          	jal	ra,1aa4 <fork>
        if(pid == 0) {
    1b3e:	34fd                	addiw	s1,s1,-1
    1b40:	cd29                	beqz	a0,1b9a <main+0x84>
    for(int i = 0; i < NUM; ++i) {
    1b42:	fce5                	bnez	s1,1b3a <main+0x24>
            exit(0);
        }
    }
    
    int xstate = 0;
    1b44:	c602                	sw	zero,12(sp)
    1b46:	4479                	li	s0,30
    for(int i = 0; i < NUM; ++i) {
        assert(wait(-1, &xstate) > 0, -1);
    1b48:	006c                	addi	a1,sp,12
    1b4a:	557d                	li	a0,-1
    1b4c:	f6fff0ef          	jal	ra,1aba <wait>
    1b50:	55fd                	li	a1,-1
    1b52:	00a02533          	sgtz	a0,a0
    1b56:	88fff0ef          	jal	ra,13e4 <assert>
        assert(xstate == 0, -2);
    1b5a:	4532                	lw	a0,12(sp)
    1b5c:	347d                	addiw	s0,s0,-1
    1b5e:	55f9                	li	a1,-2
    1b60:	00153513          	seqz	a0,a0
    1b64:	881ff0ef          	jal	ra,13e4 <assert>
    for(int i = 0; i < NUM; ++i) {
    1b68:	f065                	bnez	s0,1b48 <main+0x32>
    }
    assert(wait(-1, &xstate) < 0, -3);
    1b6a:	006c                	addi	a1,sp,12
    1b6c:	557d                	li	a0,-1
    1b6e:	f4dff0ef          	jal	ra,1aba <wait>
    1b72:	55f5                	li	a1,-3
    1b74:	01f5551b          	srliw	a0,a0,0x1f
    1b78:	86dff0ef          	jal	ra,13e4 <assert>
    printf("forktest2 test passed!\n");
    1b7c:	00000517          	auipc	a0,0x0
    1b80:	08450513          	addi	a0,a0,132 # 1c00 <main+0xea>
    1b84:	d1cff0ef          	jal	ra,10a0 <printf>
    return 0;
}
    1b88:	70e2                	ld	ra,56(sp)
    1b8a:	7442                	ld	s0,48(sp)
    1b8c:	74a2                	ld	s1,40(sp)
    1b8e:	7902                	ld	s2,32(sp)
    1b90:	69e2                	ld	s3,24(sp)
    1b92:	6a42                	ld	s4,16(sp)
    1b94:	4501                	li	a0,0
    1b96:	6121                	addi	sp,sp,64
    1b98:	8082                	ret
            int current_time = get_time();
    1b9a:	f39ff0ef          	jal	ra,1ad2 <get_time>
            unsigned long long sleep_length = current_time * current_time % 1000 + 1000;
    1b9e:	02a5053b          	mulw	a0,a0,a0
    1ba2:	0345643b          	remw	s0,a0,s4
            printf("pid %d sleep for %p ms\n", getpid(), sleep_length);
    1ba6:	ee7ff0ef          	jal	ra,1a8c <getpid>
    1baa:	85aa                	mv	a1,a0
    1bac:	854e                	mv	a0,s3
            unsigned long long sleep_length = current_time * current_time % 1000 + 1000;
    1bae:	3e84041b          	addiw	s0,s0,1000
            printf("pid %d sleep for %p ms\n", getpid(), sleep_length);
    1bb2:	8622                	mv	a2,s0
    1bb4:	cecff0ef          	jal	ra,10a0 <printf>
            sleep(sleep_length);
    1bb8:	8522                	mv	a0,s0
    1bba:	f23ff0ef          	jal	ra,1adc <sleep>
            printf("pid %d OK!\n", getpid());
    1bbe:	ecfff0ef          	jal	ra,1a8c <getpid>
    1bc2:	85aa                	mv	a1,a0
    1bc4:	854a                	mv	a0,s2
    1bc6:	cdaff0ef          	jal	ra,10a0 <printf>
            exit(0);
    1bca:	4501                	li	a0,0
    1bcc:	ee5ff0ef          	jal	ra,1ab0 <exit>
    for(int i = 0; i < NUM; ++i) {
    1bd0:	f4ad                	bnez	s1,1b3a <main+0x24>
    1bd2:	bf8d                	j	1b44 <main+0x2e>
