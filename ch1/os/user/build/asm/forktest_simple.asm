...
/home/tonyfu/riscv/ucore-Tutorial/user/build/riscv64/forktest_simple:     file format elf64-littleriscv
...
int putchar(int c)
{
    ...
    1042:	c7258593          	addi	a1,a1,-910 # 1cb0 <put.1058>
...
int puts(const char* s)
{
    ...
    1082:	c3258593          	addi	a1,a1,-974 # 1cb0 <put.1058>
    1086:	47a9                	li	a5,10
    return write(stdout, put, 1);
    1088:	4605                	li	a2,1
    108a:	4501                	li	a0,0
...
void printf(const char* fmt, ...) {
    ...
    10e8:	bcc40413          	addi	s0,s0,-1076 # 1cb0 <put.1058>
    10ec:	03000c93          	li	s9,48
    10f0:	07800c13          	li	s8,120
    10f4:	00001b17          	auipc	s6,0x1
    10f8:	ba4b0b13          	addi	s6,s6,-1116 # 1c98 <digits>
        if (c != '%') {
    ...
    125e:	a5658593          	addi	a1,a1,-1450 # 1cb0 <put.1058>
    1262:	4501                	li	a0,0
    put[0] = c;
    ...
    12b4:	a0058593          	addi	a1,a1,-1536 # 1cb0 <put.1058>
                printptr(va_arg(ap, uint64));
    ...
    12d2:	9e258593          	addi	a1,a1,-1566 # 1cb0 <put.1058>
    12d6:	4501                	li	a0,0
    put[0] = c;
    ...
    1318:	99c58593          	addi	a1,a1,-1636 # 1cb0 <put.1058>
    131c:	4501                	li	a0,0
    put[0] = c;
    ...
    132c:	98858593          	addi	a1,a1,-1656 # 1cb0 <put.1058>
    1330:	4501                	li	a0,0
    put[0] = c;
    ...
    134e:	96658593          	addi	a1,a1,-1690 # 1cb0 <put.1058>
    1352:	4501                	li	a0,0
    put[0] = c;
    ...
    138e:	8e648493          	addi	s1,s1,-1818 # 1c70 <main+0x15a>
                for (; *s; s++)
...
void srand(unsigned s) {
    ...
    13ac:	90a7b823          	sd	a0,-1776(a5) # 1cb8 <seed>
}
    13b0:	8082                	ret
...
int rand(void) {
    ...
    13b6:	90678793          	addi	a5,a5,-1786 # 1cb8 <seed>
    13ba:	6388                	ld	a0,0(a5)
    13bc:	00001717          	auipc	a4,0x1
    13c0:	8bc73703          	ld	a4,-1860(a4) # 1c78 <main+0x162>
...
size_t strlen(const char* s)
{
    ...
    16e0:	5a45b583          	ld	a1,1444(a1) # 1c80 <main+0x16a>
    16e4:	00000617          	auipc	a2,0x0
    16e8:	5a463603          	ld	a2,1444(a2) # 1c88 <main+0x172>
    ...
    1718:	00757713          	andi	a4,a0,7
{
    ...
    1748:	54c53503          	ld	a0,1356(a0) # 1c90 <main+0x17a>
    ...
    175a:	52a8b883          	ld	a7,1322(a7) # 1c80 <main+0x16a>
    175e:	00000817          	auipc	a6,0x0
    1762:	52a83803          	ld	a6,1322(a6) # 1c88 <main+0x172>
    1766:	431d                	li	t1,7
...
char* stpcpy(char* restrict d, const char* s)
{
    ...
    17e8:	49c63603          	ld	a2,1180(a2) # 1c80 <main+0x16a>
    17ec:	00000817          	auipc	a6,0x0
    17f0:	49c83803          	ld	a6,1180(a6) # 1c88 <main+0x172>
...
char* stpncpy(char* restrict d, const char* s, size_t n)
{
    ...
    19ca:	2ba8b883          	ld	a7,698(a7) # 1c80 <main+0x16a>
    19ce:	00000817          	auipc	a6,0x0
    19d2:	2ba83803          	ld	a6,698(a6) # 1c88 <main+0x172>
    19d6:	431d                	li	t1,7
...
int main() {
    1b16:	1101                	addi	sp,sp,-32
    assert(wait(0, 0) < 0, -1);
    1b18:	4581                	li	a1,0
    1b1a:	4501                	li	a0,0
int main() {
    1b1c:	ec06                	sd	ra,24(sp)
    1b1e:	e822                	sd	s0,16(sp)
    assert(wait(0, 0) < 0, -1);
    1b20:	f9bff0ef          	jal	ra,1aba <wait>
    1b24:	55fd                	li	a1,-1
    1b26:	01f5551b          	srliw	a0,a0,0x1f
    1b2a:	8bbff0ef          	jal	ra,13e4 <assert>
    printf("sys_wait without child process test passed!\n");
    1b2e:	00000517          	auipc	a0,0x0
    1b32:	08a50513          	addi	a0,a0,138 # 1bb8 <main+0xa2>
    1b36:	d6aff0ef          	jal	ra,10a0 <printf>
    printf("parent start, pid = %d!\n", getpid());
    1b3a:	f53ff0ef          	jal	ra,1a8c <getpid>
    1b3e:	85aa                	mv	a1,a0
    1b40:	00000517          	auipc	a0,0x0
    1b44:	0a850513          	addi	a0,a0,168 # 1be8 <main+0xd2>
    1b48:	d58ff0ef          	jal	ra,10a0 <printf>
    int pid = fork();
    1b4c:	f59ff0ef          	jal	ra,1aa4 <fork>
    if(pid == 0) {
    1b50:	c921                	beqz	a0,1ba0 <main+0x8a>
        // child process
    ...
    1b54:	00000517          	auipc	a0,0x0
    1b58:	0cc50513          	addi	a0,a0,204 # 1c20 <main+0x10a>
        int xstate = 0;
    1b5c:	c602                	sw	zero,12(sp)
        printf("ready waiting on parent process!\n");
    1b5e:	d42ff0ef          	jal	ra,10a0 <printf>
        assert(pid == wait(0, &xstate), -2);
    1b62:	006c                	addi	a1,sp,12
    1b64:	4501                	li	a0,0
    1b66:	f55ff0ef          	jal	ra,1aba <wait>
    1b6a:	8d01                	sub	a0,a0,s0
    1b6c:	55f9                	li	a1,-2
    1b6e:	00153513          	seqz	a0,a0
    1b72:	873ff0ef          	jal	ra,13e4 <assert>
        assert(xstate == 100, -3);
    1b76:	4532                	lw	a0,12(sp)
    1b78:	55f5                	li	a1,-3
    1b7a:	f9c50513          	addi	a0,a0,-100
    1b7e:	00153513          	seqz	a0,a0
    1b82:	863ff0ef          	jal	ra,13e4 <assert>
        printf("child process pid = %d, exit code = %d\n", pid, xstate);
    1b86:	4632                	lw	a2,12(sp)
    1b88:	00000517          	auipc	a0,0x0
    1b8c:	0c050513          	addi	a0,a0,192 # 1c48 <main+0x132>
    1b90:	85a2                	mv	a1,s0
    1b92:	d0eff0ef          	jal	ra,10a0 <printf>
    }
    return 0;
    1b96:	4501                	li	a0,0
    1b98:	60e2                	ld	ra,24(sp)
    1b9a:	6442                	ld	s0,16(sp)
    1b9c:	6105                	addi	sp,sp,32
    1b9e:	8082                	ret
        printf("hello child process!\n");
    1ba0:	00000517          	auipc	a0,0x0
    1ba4:	06850513          	addi	a0,a0,104 # 1c08 <main+0xf2>
    1ba8:	cf8ff0ef          	jal	ra,10a0 <printf>
        return 100;
    1bac:	06400513          	li	a0,100
    1bb0:	b7e5                	j	1b98 <main+0x82>
