...
/home/tonyfu/riscv/ucore-Tutorial/user/build/riscv64/getchar_simple:     file format elf64-littleriscv
...
int main() {
    ...
    1ad0:	02c50513          	addi	a0,a0,44 # 1af8 <main+0x2e>
int main() {
    1ad4:	e022                	sd	s0,0(sp)
    1ad6:	e406                	sd	ra,8(sp)
    printf("getchar 10:");
    1ad8:	4429                	li	s0,10
    1ada:	dc6ff0ef          	jal	ra,10a0 <printf>
    for(int i = 0; i < 10; ++i) {
        int c = getchar();
    1ade:	347d                	addiw	s0,s0,-1
    1ae0:	d3aff0ef          	jal	ra,101a <getchar>
        putchar(c);
    1ae4:	d54ff0ef          	jal	ra,1038 <putchar>
    for(int i = 0; i < 10; ++i) {
    1ae8:	f87d                	bnez	s0,1ade <main+0x14>
    }
    return 0;
    1aea:	60a2                	ld	ra,8(sp)
    1aec:	6402                	ld	s0,0(sp)
    1aee:	4501                	li	a0,0
    1af0:	0141                	addi	sp,sp,16
    1af2:	8082                	ret
